...
public class AddPlaceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        prePlaceId = intent.getStringExtra(ActivityHelper.PREV_PLACE_ID);
        ...
        refTours.orderByChild("id").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                ChangePlaceCustomListView customListView = new ChangePlaceCustomListView(AddPlaceActivity.this, places);
                                ...
                                for (DataSnapshot tourSnapshot : dataSnapshot.getChildren()) {
                                    ...
                                    for (int i = 0; i < listOfPlacesPerDay.size(); i++) {
                                        ...
                                        for (int j = 0; j<placeIdsPerDay.size(); j++) {
                                            if (placeIdsPerDay.get(j).equals(prePlaceId)) {
                    ...
                    refTravels.orderByChild("id").equalTo(travelFromTo).addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                            ...
                            if (travel != null) {
                                ...
                                Toast.makeText(AddPlaceActivity.this, "Tour changed", Toast.LENGTH_LONG).show();
                                Log.d(TAG, "Tour " + tourName + " changed");

                                Intent intent = new Intent(AddPlaceActivity.this, ViewTourActivity.class);
